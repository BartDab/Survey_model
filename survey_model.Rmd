...
```{r}
set.seed(42)
model4<-randomForest(Praca~.,data=df6,ntrees=500,mtry=5,importance=TRUE)
print(model4)
randomForest::importance(model4,class=TRUE)
varImpPlot(model4)
```
...
```{r}
set.seed(42)
model5<-randomForest(Praca~.,data=df6,ntrees=500,mtry=5,importance=TRUE,sampsize=c(120,120))
print(model5)
randomForest::importance(model5,class=TRUE)
varImpPlot(model5)
```
