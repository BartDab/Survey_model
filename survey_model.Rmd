...
data3<-df0%>%
  dplyr::group_by(Wiek)%>%
  dplyr::count()
g2<-ggplot(data3, aes(x=as.factor(data3$Wiek),y=data3$n,fill=as.factor(data3$Wiek)))+geom_bar(stat='identity')+ theme(legend.position = "none")+
...
data4<-df0%>%
  ...
  dplyr::count()
g3<-ggplot(data4, aes(x=data4$Wojewodztwo_pochodzenia,y=data4$n,fill=data4$Wojewodztwo_pochodzenia))+geom_bar(stat='identity')+ theme(legend.position = "none")+
   geom_text(aes(label = n), position =position_dodge(width=0.9), vjust=-0.25)+
  xlab('')+
...
data5<-df0%>%
  ...
  dplyr::count()
g4<-ggplot(data5, aes(x=data5$Wielkosc_miasta,y=data5$n,fill=data5$Wielkosc_miasta))+geom_bar(stat='identity')+ theme(legend.position = "none")+
  geom_text(aes(label = n), position =position_dodge(width=0.9), vjust=-0.25)+
...
data2<-df0%>%
  ...
  dplyr::count()
g26<-ggplot(data2, aes(x=data2$Akademik,y=data2$n,fill=data2$Akademik))+geom_bar(stat='identity')+ theme(legend.position = "none")+
  geom_text(aes(label = n), position =position_dodge(width=0.9), vjust=-0.25)+
  xlab('')+ylab('')+ ggtitle('Mieszkanie w akademiku')+theme(plot.title = element_text(hjust = 0.5))+scale_color_viridis(option = "B")+scale_x_discrete(limits=c(0,1))
g26
```
...
g27<-ggplot(data2, aes(x=data2$Dom_mieszkanie_rodzinne,y=data2$n,fill=data2$Dom_mieszkanie_rodzinne))+geom_bar(stat='identity')+ theme(legend.position = "none")+
  geom_text(aes(label = n), position =position_dodge(width=0.9), vjust=-0.25)+
  xlab('')+ylab('')+ ggtitle('Mieszkanie w domu bądź mieszkaniu własnym')+theme(plot.title = element_text(hjust = 0.5))+scale_color_viridis(option = "B")+scale_x_discrete(limits=c(0,1))
g27
```
...
data2<-df0%>%
  ...
  dplyr::count()
g28<-ggplot(data2, aes(x=data2$Wynajete_mieszkanie,y=data2$n,fill=data2$Wynajete_mieszkanie))+geom_bar(stat='identity')+ theme(legend.position = "none")+
  geom_text(aes(label = n), position =position_dodge(width=0.9), vjust=-0.25)+
  xlab('')+ylab('')+ ggtitle('Mieszkanie w mieszkaniu wynajętym')+theme(plot.title = element_text(hjust = 0.5))+scale_color_viridis(option = "B")+scale_x_discrete(limits=c(0,1))
g28
```
...
data2<-df0%>%
  ...
  dplyr::count()
g29<-ggplot(data2, aes(x=data2$Wynajety_pokoj,y=data2$n,fill=data2$Wynajety_pokoj))+geom_bar(stat='identity')+ theme(legend.position = "none")+
  geom_text(aes(label = n), position =position_dodge(width=0.9), vjust=-0.25)+
  xlab('')+ylab('')+ ggtitle('Mieszkanie w domu bądź mieszkaniu własnym')+theme(plot.title = element_text(hjust = 0.5))+scale_color_viridis(option = "B")+scale_x_discrete(limits=c(0,1))
g29
```
...
data2<-df0%>%
  dplyr::group_by(Inne)%>%
  dplyr::count()
g30<-ggplot(data2, aes(x=data2$Inne,y=data2$n,fill=data2$Inne))+geom_bar(stat='identity')+ theme(legend.position = "none")+
  geom_text(aes(label = n), position =position_dodge(width=0.9), vjust=-0.25)+
  xlab('')+ylab('')+ ggtitle('Mieszkanie w opcji niewymienionej w ankiecie')+theme(plot.title = element_text(hjust = 0.5))+scale_color_viridis(option = "B")+scale_x_discrete(limits=c(0,1))
g30
```
...
data2<-df0%>%
  ...
  dplyr::count()
g31<-ggplot(data2, aes(x=data2$Dyscyplina,y=data2$n,fill=data2$Dyscyplina))+geom_bar(stat='identity')+ theme(legend.position = "none")+
  geom_text(aes(label = n), position =position_dodge(width=0.9), vjust=-0.25)+
